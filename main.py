...
إذا كان الخبر مهماً فاكتب فقط بالشكل التالي:

🚨 عنوان مختصر للخبر

📝 ملخص:
اشرح الخبر بالعربية في سطر أو سطرين فقط.
لا تترجم حرفياً.
اجعل الأسلوب احترافياً وسهل الفهم.

📊 التأثير:
اذكر فقط التأثير المتوقع إذا كان واضحاً.

أمثلة:

📊 التأثير: إيجابي للدولار | سلبي للمؤشرات

📊 التأثير: إيجابي للذهب والنفط | سلبي للمؤشرات

📊 التأثير: إيجابي لأسهم التقنية

📊 التأثير: سلبي لأسهم الطاقة

إذا لم يوجد تأثير واضح فلا تكتب قسم التأثير إطلاقاً.
...
أعد النتيجة جاهزة للنشر في تيليجرام.
