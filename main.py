...
1- إذا كان الخبر اقتصادياً أو جيوسياسياً (مثل الفيدرالي، التضخم، الوظائف، الفائدة، النفط، الذهب، أوبك، الحروب، الرسوم الجمركية، العقوبات...) فاكتب:

🚨 عنوان الخبر

📊 التأثير: اذكر التأثير فقط إذا كان واضحاً.

أمثلة:
📊 التأثير: إيجابي للدولار | سلبي للمؤشرات
📊 التأثير: إيجابي للذهب | سلبي للدولار
📊 التأثير: إيجابي للنفط

2- إذا كان الخبر يتعلق بشركة (نتائج، استحواذ، تقسيم، منتج جديد، شراكة، تعيينات، إلخ) فاكتب:
